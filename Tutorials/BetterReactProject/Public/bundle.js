...
/***/ function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
	    ...
	    onHandleFormSubmit: function onHandleFormSubmit(e) //function(e,y)
	    {
	        this.setState(e);
	        var uName = e.uName;
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'h1',
	                null,
	                'Hello World this is Seventh Lesson'
	            ),
	            React.createElement(GreeterMessage, { name: nameFromState, message: messageFromState }),
	            React.createElement(GreeterForm, { onFormSubmission: this.onHandleFormSubmit })
	        );
	    }
	});
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "h4",
	                null,
	                messageFromState + " by " + nameFromState
	            )
	        );
	    }
	});
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'text', placeholder: 'Enter Name', ref: 'userName' }),
	                React.createElement('input', { type: 'message', placeholder: 'Enter Message', ref: 'userMessage' }),
	                React.createElement('input', { type: 'submit', value: 'Submit Name' })
	            )
	        );
	    }
	});
